    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Continents</a>
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <?php
            foreach($desContinents as $continent)
            {
                echo '<a class="dropdown-item" href="?continent=' .$continent->Continent.'">' .$continent->Continent. ' </a>';
            };
            ?>
          </div>
        </li>
